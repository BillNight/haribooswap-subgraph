...
import { updatePairDayData, updateTokenDayData, updateNarwhalswapDayData, updatePairHourData } from './dayUpdates'
...
export function handleTransfer(event: Transfer): void {
  ...
  let factory = NarwhalswapFactory.load(FACTORY_ADDRESS)
...
export function handleSync(event: Sync): void {
  ...
  let narwhalswap = NarwhalswapFactory.load(FACTORY_ADDRESS)

  // reset factory liquidity by subtracting onluy tarcked liquidity
  narwhalswap.totalLiquidityBNB = narwhalswap.totalLiquidityBNB.minus(pair.trackedReserveBNB as BigDecimal)
  ...
  narwhalswap.totalLiquidityBNB = narwhalswap.totalLiquidityBNB.plus(trackedLiquidityBNB)
  narwhalswap.totalLiquidityUSD = narwhalswap.totalLiquidityBNB.times(bundle.bnbPrice)
...
export function handleMint(event: Mint): void {
  ...
  narwhalswap.txCount = narwhalswap.txCount.plus(ONE_BI)
  ...
  updateNarwhalswapDayData(event)
...
export function handleSwap(event: Swap): void {
  ...
  let narwhalswap = NarwhalswapFactory.load(FACTORY_ADDRESS)
  narwhalswap.totalVolumeUSD = narwhalswap.totalVolumeUSD.plus(trackedAmountUSD)
  narwhalswap.totalVolumeBNB = narwhalswap.totalVolumeBNB.plus(trackedAmountBNB)
  narwhalswap.untrackedVolumeUSD = narwhalswap.untrackedVolumeUSD.plus(derivedAmountUSD)
  narwhalswap.txCount = narwhalswap.txCount.plus(ONE_BI)
  ...
  let narwhalswapDayData = NarwhalswapDayData.load(dayID.toString())
  narwhalswapDayData.dailyVolumeUSD = narwhalswapDayData.dailyVolumeUSD.plus(trackedAmountUSD)
  narwhalswapDayData.dailyVolumeBNB = narwhalswapDayData.dailyVolumeBNB.plus(trackedAmountBNB)
  narwhalswapDayData.dailyVolumeUntracked = narwhalswapDayData.dailyVolumeUntracked.plus(derivedAmountUSD)
  narwhalswapDayData.save()
