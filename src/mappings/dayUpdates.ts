...
import { Pair, Bundle, Token, NarwhalswapFactory, NarwhalswapDayData, PairDayData, TokenDayData } from '../types/schema'
...
export function updateNarwhalswapDayData(event: EthereumEvent): void {
  ...
  if (narwhalswapDayData == null) {
    let narwhalswapDayData = new NarwhalswapDayData(dayID.toString())
    narwhalswapDayData.date = dayStartTimestamp
    narwhalswapDayData.dailyVolumeUSD = ZERO_BD
    narwhalswapDayData.dailyVolumeBNB = ZERO_BD
    narwhalswapDayData.totalVolumeUSD = ZERO_BD
    narwhalswapDayData.totalVolumeBNB = ZERO_BD
    narwhalswapDayData.dailyVolumeUntracked = ZERO_BD
    narwhalswapDayData.totalLiquidityUSD = ZERO_BD
    narwhalswapDayData.totalLiquidityBNB = ZERO_BD
    narwhalswapDayData.maxStored = maxTokenDayDatas
    narwhalswapDayData.mostLiquidTokens = narwhalswap.mostLiquidTokens
    narwhalswapDayData.txCount = ZERO_BI
    narwhalswapDayData.save()
  }
  narwhalswapDayData = NarwhalswapDayData.load(dayID.toString())
  narwhalswapDayData.totalLiquidityUSD = narwhalswap.totalLiquidityUSD
  narwhalswapDayData.totalLiquidityBNB = narwhalswap.totalLiquidityBNB
  narwhalswapDayData.txCount = narwhalswap.txCount
  narwhalswapDayData.save()
}
